...
const HeroSection: FC<Props> = (props) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-transparent to-green-50/50 dark:from-blue-900/10 dark:via-transparent dark:to-green-900/10"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4">
              ...
              >
                Learn from industry experts and build real-world projects. Start
                your learning journey today with our modern LMS platform.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 justify-center lg:justify-start">
              <div className="flex -space-x-2">
                <Image
                  src={require("../../../public/assets/client1.png")}
                  alt="Student"
                  width={40}
                  height={40}
                ...
                />
                <Image
                  src={require("../../../public/assets/client2.png")}
                  alt="Student"
                  width={40}
                  height={40}
                  className="w-10 h-10 rounded-full border-2 border-white shadow-sm object-cover"
                />
                <Image
                  src={require("../../../public/assets/client3.png")}
                  alt="Student"
                  width={40}
                  height={40}
                  className="w-10 h-10 rounded-full border-2 border-white shadow-sm object-cover"
